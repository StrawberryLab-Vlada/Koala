...
Namespace Koala
    ...
    Public Class ThermalLoadOnBeam
        ...
        Protected Overrides Sub RegisterInputParams(pManager As GH_Component.GH_InputParamManager)
            ...
            pManager.AddNumberParameter("+y - Left delta", "+z - Top delta", "+z - Top delta", GH_ParamAccess.item, 1)
            pManager.AddNumberParameter("-y - Right delta", "-z - Bottom delta", "-z - Bottom delta", GH_ParamAccess.item, 1)
